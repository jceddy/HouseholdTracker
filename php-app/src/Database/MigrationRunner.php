...
namespace HouseholdTracker\Database;
...
final class MigrationRunner
{
     ...
     *     migration's filename immediately after it applies
    ...
    public static function applyPending(\PDO $pdo, ?string $migrationsDir = null, ?callable $onApplied = null): array
    {
        ...
        foreach ($files as $file) {
            ...
            // Naive statement split: fine as long as this project's DDL-only
            // migrations never need a semicolon inside a string, trigger, or
            // procedure.
